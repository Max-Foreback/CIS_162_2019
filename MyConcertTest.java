...
public class MyConcertTest {
    ...
    public void testConstructor2() {
        Concert concert = new Concert(11, 7, 2019, "Itzhak Perlman", 
    ...
    public void testInvalidDateConstructor2(){
        // invalid month
        Concert concert = new Concert(13, 20, 2019, "Itzhak Perlman", 
                "DeVos Performance Hall");
        Assert.assertEquals("trying to initialize an invalid month", 0, concert.getMonth());

        // invalid day - not leap year
        concert = new Concert(2, 29, 1900, "Itzhak Perlman", "DeVos Performance Hall");
        Assert.assertEquals("trying to initialize on invalid day - not leap year",
            0, concert.getDay());

        // invalid day - not a valid day for June
        concert = new Concert(6, 31, 2020, "Itzhak Perlman", "DeVos Performance Hall");
        Assert.assertEquals("trying to initialize on invalid day for June",
            0, concert.getDay());

        // invalid year - negative year
        concert = new Concert(7, 4, -2000, "Itzhak Perlman", "DeVos Performance Hall");
        Assert.assertEquals("trying to initialize an invalid year - negative year", 
            0, concert.getYear());
    }
    ...
    public void testInvalidDateConstructor3(){
        ...
        // invalid day - not a valid day for September
        concert = new Concert(9, 35, 2020, "Itzhak Perlman", "DeVos Performance Hall");
        Assert.assertEquals("trying to initialize on invalid day for September",
            0, concert.getDay());

        // invalid year - negative year
        concert = new Concert("7/4/-2000", "Itzhak Perlman", "DeVos Performance Hall");
        Assert.assertEquals("trying to initialize an invalid year - negative year", 0,
            concert.getYear());      
    } 
    ...
    public void testFormatDate(){    
        ...
        Assert.assertEquals("Problems with formatting the date as required - " +
            "one or two digits for month and day : mm/dd/yyyy","1/10/1995", 
            concert.formatDate(1));   
